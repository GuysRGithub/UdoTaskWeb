  ...
  return (
    <div className="app">
      ...
      <section id='privacy-policy' className='px-64 mt-16'>
        ...
        <p>
          This privacy notice for UdoTask <span> ("Company ," "we," "us," or "our" )</span>, describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("<span>Services</span>"), such as when you:</p>
        <ul>
          <li>
            Download and use our mobile application (UdoTask) , or any other application of ours that links to this privacy notice
          </li>
          <li>
        ...
        <div>
          ...
          <p><span>What personal information do we process?</span>When you visit, use, or navigate our Services, we may process personal information depending on how you interact with UdoTask and the Services, the choices you make, and the products and features you use. Click  <a href="#personal-info">here</a> to learn more.</p>
          ...
          <p>Want to learn more about what UdoTask does with any information we collect? Click  <a href="#toc">here</a> to review the notice in full.</p>
        </div>
        ...
        <div id="ca">
          ...
          <p className='p-text-bold'> UdoTask has not sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months.</p>
          <p>UdoTask  has disclosed the following categories of personal information to third parties for a business or commercial purpose in the preceding twelve (12) months: </p>
          <ul>
            <li>
